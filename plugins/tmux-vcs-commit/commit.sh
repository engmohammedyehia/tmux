...
git_status() {
  ...
  if [[ -n $commit_name ]]; then
    printf "#[fg=$change_color,bg=#121212,nobold]#[fg=$label_color,bg=$change_color,nobold] $commitIcon $commit_name #[fg=#427ab3,bg=$change_color,nobold]#[fg=#000000,bg=#427ab3,nobold] $(whoami) $lockIcon "
  else 
